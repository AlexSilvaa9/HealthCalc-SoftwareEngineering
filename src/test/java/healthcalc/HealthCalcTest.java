...
public class HealthCalcTest {
	...
	public void alturaNegIW() {
		...
		assertThrows(RuntimeException.class, () -> calc.idealWeight(-10, Gender.MALE));
	}
	@Test
	@DisplayName("Altura cero en Ideal Weight")
	public void alturaCeroIW() {
		
		assertThrows(RuntimeException.class, () -> calc.idealWeight(0, Gender.MALE));
	}
	@Test
	@DisplayName("Genero ni 'm', ni 'f' en Ideal Weight")
	public void generomalIW() {
		assertThrows(RuntimeException.class, () -> calc.idealWeight(10, null));
	...
	public void generoMayIW() throws Exception {
		assertEquals(58, calc.idealWeight(160, Gender.MALE));
	}
	@Test
	...
	public void altura190IW() throws Exception{
		assertEquals(80, calc.idealWeight(190, Gender.MALE));
	}
	@Test
	...
	public void generoFIW() throws Exception{
		assertEquals(74, calc.idealWeight(190, Gender.FEMALE));
	...
	public void pnegBMR() {
		assertThrows(RuntimeException.class, () -> calc.basalMetabolicRate(-60, 170, Gender.MALE, 20));
	}
	@Test
	@DisplayName("Peso cero en basalMetabolicRate")
	public void pCeroBMR() {
		assertThrows(RuntimeException.class, () -> calc.basalMetabolicRate(0, 170, Gender.MALE, 20));
	}
	@Test
	...
	public void altCeroBMR() {
		assertThrows(RuntimeException.class, () -> calc.basalMetabolicRate(60, 0, Gender.MALE, 20));
	...
	public void edadCeroBMR() {
		assertThrows(RuntimeException.class, () -> calc.basalMetabolicRate(60, 170, Gender.MALE, 0));
	}
	@Test
	@DisplayName("Genero ni 'm', ni 'f' en basalMetabolicRate")
	public void generomalBMR() {
		assertThrows(RuntimeException.class, () -> calc.basalMetabolicRate(60, 170, null, 20));

	}
	@Test
	@DisplayName("Genero mayusculas en basalMetabolicRate")
	public void generoMayBMR() throws Exception{
		assertEquals(1567.5, calc.basalMetabolicRate(60, 170, Gender.MALE, 20));
	}
	@Test
	...
	public void peso150Altura200Edad90BMR() throws Exception{
		assertEquals(2305.0, calc.basalMetabolicRate(150, 200, Gender.MALE, 90));

	}
	@Test
	@DisplayName("Desbordamiento en basalMetabolicRate")
	public void desbordBMR() {
		assertThrows(ArithmeticException.class,() -> calc.basalMetabolicRate(Float.MAX_VALUE, Integer.MAX_VALUE, Gender.MALE, 10));
	}
	@Test
	...
	public void generoFBMR() throws Exception{
		assertEquals(2139.0, calc.basalMetabolicRate(150, 200, Gender.FEMALE, 90));
	}
}
